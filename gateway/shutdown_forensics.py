...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    # Query the manager that owns the cgroup.  Asking the user manager first
    # for a system unit can find a stale same-named user unit and report its
    # timeout as if it governed this process.
