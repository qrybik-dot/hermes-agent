...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # Telegram is usually a mobile inbox: keep tool_progress quiet and keep
    # natural assistant commentary out of chat by default. Long-running
    # notifications remain on so users get one editable status bubble instead
    # of detailed reasoning/progress messages. Opt in to verbose commentary or
    # iteration detail via display.platforms.telegram.*.
    "telegram":    {
        **_TIER_HIGH,
        "tool_progress": "off",
        "interim_assistant_messages": False,
