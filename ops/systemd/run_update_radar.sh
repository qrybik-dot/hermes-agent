...
OUTPUT=$(/home/hermes/hermes-runtime/shared/venv/bin/python /home/hermes/hermes-runtime/current/scripts/update_radar.py --telegram-card 2>"$ERR_LOG") || {
  STATUS=$?
...
/home/hermes/hermes-runtime/shared/venv/bin/python -m hermes_cli.main send --to telegram "$MESSAGE"
