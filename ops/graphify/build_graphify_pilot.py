...
graph = {
    ...
    'metadata': {'generator': 'hermes deterministic markdown pilot', 'graphify_version': '0.9.5', 'allowlist_count': len(ALLOW), 'generated_at': time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime()), 'llm_used': False},
}
