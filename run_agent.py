...
class AIAgent:
    ...
    def _has_pending_fallback(self, reason: "FailoverReason | str | None" = None) -> bool:
        """Return whether the remaining chain has an entry allowed for this failure reason."""
